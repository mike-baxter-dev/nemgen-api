...
public class ApiGatewayProxyRequest {
    ...
    public ApiGatewayProxyRequest(String resource, String path, String httpMethod, Map<String, String> headers, Map<String, String> queryStringParameters, Map<String, String> pathParameters, Map<String, String> stageVariables, RequestContext requestContext, String body, boolean isBase64Encoded) {
